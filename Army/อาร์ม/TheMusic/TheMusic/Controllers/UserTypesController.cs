...
namespace TheMusic.Controllers
{
    public class UserTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TypeUserID,TypeUserName")] UserType userType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TypeUserID,TypeUserName")] UserType userType)
        {
            if (ModelState.IsValid)
            {
